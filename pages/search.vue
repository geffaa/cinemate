<template>
    <div>
        ...
        <section>
            <h1 v-if="movies.length" class="mt-8 mb-16 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-4xl text-center dark:text-white items">Movie Results</h1>
        ...
        <section>
            <h1 v-if="series.length" class="mb-16 text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-4xl text-center dark:text-white">Tv Series Results</h1>
